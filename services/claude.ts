  ...
  "artifacts": [
    {
      ...
      "transportType": "bus|train|ferry|car_rental|drive|taxi|rideshare|other",
...
- GROUND TRANSPORT: Use type "ground_transport" for bus tickets, coach/shuttle bookings, train/rail reservations, ferry/boat tickets, taxi receipts, car rental confirmations, and rideshare receipts (Uber, Lyft, Bolt, etc.). Set "transportType" to the best match: "bus" (intercity coaches, airport shuttles, city buses), "train" (rail, metro, Eurostar, Amtrak, Shinkansen), "ferry" (boats, water taxis, catamarans), "car_rental" (hired cars with a rental agreement), "drive" (personal/own vehicle road trips — no rental agreement), "taxi" (metered taxi), "rideshare" (app-based rides). Use "transportType": "other" only when none of the above fits. Never use artifact type "car_rental" — always use type "ground_transport" with transportType "car_rental".
